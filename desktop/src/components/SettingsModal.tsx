        ...
        setUpdateResult({
          ...
          availableDownloads: [
            ...
            },
            {
              ...
              url: `https://github.com/ARAEMXA26/Nusa-Agent/releases/latest/download/Nusa-Agent-win-x64.exe`,
              isCurrentDevice: false,
            },
            {
              os: 'linux',
              ...
              url: `https://github.com/ARAEMXA26/Nusa-Agent/releases/latest/download/Nusa-Agent-linux-x64.AppImage`,
              isCurrentDevice: false,
            }
          ],
